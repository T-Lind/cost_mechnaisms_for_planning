...
#                         mdp.addTransition(trans)
    ...
    def __simulate_markovStateVisible_generalAndGreedy(self, policy, printOutput =True):
        ...
        while True:
            ...
            if q2 not in self.dfa.final_states:
                steps2 += 1
                eventLisToPredict = AutomataUtility.getNonSelfLoopLetters(self.dfa, q2)
            ...
            if printOutput == True:
                print(str(i)+". "+"q="+(q_previous if q_previous not in self.dfa.final_states else "")+"q2="+(q2_previous if q2_previous not in self.dfa.final_states else "")+", s="+s.name+", predicted="+predictedEvent+", predicted2="+predictedEvent2+", actual="+str(s2.events)+", sNext="+s2.name+", recorded story="+story+", recorded story2="+story2)  
    ...
    def __simulate_markovStateVisible_greedyalgorithm(self, printOutput =True):
        ...
        while True:
            ...
            eventLisToPredict = AutomataUtility.getNonSelfLoopLetters(self.dfa, q)
